...
Define the authenticated, read-only Organization chart experience for progressively exploring Team hierarchy, inspecting Team context, and explicitly pivoting the visualization without exposing administrative or mutation behavior.
