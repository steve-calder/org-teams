# Personal Organization Dashboard Specification

## Purpose

Define the trusted, read-only homepage view that helps an authenticated Person understand their current participation across Organizations, Teams, roles, and contextual managers.
