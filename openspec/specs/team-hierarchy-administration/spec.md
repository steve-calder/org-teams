# Team Hierarchy Administration

## Purpose

Define global-administrator controls and integrity rules for one Team hierarchy per Organization, Team manager assignments, and hierarchy-derived manager supervision.
