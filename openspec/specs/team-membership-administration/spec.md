...
Define global-administrator controls, integrity rules, contextual reporting inputs, and audit history for ordinary Team memberships and manager-as-member behavior.
